                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                        <form method="GET" action="{{ route('admin.users.index') }}" class="flex-1 flex flex-col sm:flex-row gap-3">
                            <div class="relative flex-1">
                                <input type="text" name="search" value="{{ request('search') }}" class="modern-search-input" placeholder="Search users by name or email...">
                            ...
                            <select name="role" class="modern-filter-dropdown">
                        ...
                        <div class="flex gap-2 mt-3 sm:mt-0">
                            <a href="{{ route('admin.users.export') }}" class="modern-btn modern-btn-success">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path>
                                </svg>
                                Export
                            </a>
                            <a href="{{ route('admin.users.create') }}" class="modern-btn modern-btn-primary">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <table class="modern-table datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-table-header">Role</th>
                                    <th class="text-table-header">Status</th>
                                    <th class="text-table-header">Created At</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-table-body">{{ $user->id }}</td>
                                    <td class="text-table-body">{{ $user->name }}</td>
                                    <td class="text-table-body">{{ $user->email }}</td>
                                    ...
                                    <td class="text-table-body">{{ $user->created_at->format('M d, Y') }}</td>
                                    <td class="text-right">
                                        <div class="action-buttons flex gap-2 justify-end">
                                            <a href="{{ route('admin.users.show', $user->id) }}" class="modern-action-btn modern-action-btn-view">
                                            ...
                                            <a href="{{ route('admin.users.edit', $user->id) }}" class="modern-action-btn modern-action-btn-edit">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                </svg>
                                                Edit
                                            </a>
                                            <button class="modern-action-btn modern-action-btn-delete" onclick="confirmDelete('{{ $user->id }}')">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
