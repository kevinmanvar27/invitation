                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.rsvp-responses.update', $rsvpResponse->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="guest_name" id="guest_name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('guest_name', $rsvpResponse->guest_name) }}" required>
                            @error('guest_name')
                                <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="guest_email" id="guest_email" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('guest_email', $rsvpResponse->guest_email) }}">
                            @error('guest_email')
                                <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="guest_phone" id="guest_phone" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('guest_phone', $rsvpResponse->guest_phone) }}">
                            @error('guest_phone')
                                <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="plus_ones_count" id="plus_ones_count" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('plus_ones_count', $rsvpResponse->plus_ones_count) }}" min="0">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="meal_preference" id="meal_preference" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('meal_preference', $rsvpResponse->meal_preference) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="special_requests" id="special_requests" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" rows="3">{{ old('special_requests', $rsvpResponse->special_requests) }}</textarea>
                        ...
                        <!-- Responded At -->
                        <div class="mb-4">
                            <label for="responded_at" class="block text-gray-700 text-sm font-bold mb-2">Responded At</label>
                            <input type="datetime-local" name="responded_at" id="responded_at" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('responded_at', $rsvpResponse->responded_at ? $rsvpResponse->responded_at->format('Y-m-d\TH:i') : '') }}">
                            @error('responded_at')
                                <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
