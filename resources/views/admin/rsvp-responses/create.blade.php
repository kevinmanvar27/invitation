                ...
                <div class="p-6 text-primary-dark">
                    ...
                    <form method="POST" action="{{ route('admin.rsvp-responses.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="guest_name" id="guest_name" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('guest_name') }}" required>
                            @error('guest_name')
                                <p class="text-error-dark text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="guest_email" id="guest_email" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('guest_email') }}">
                            @error('guest_email')
                                <p class="text-error-dark text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="guest_phone" id="guest_phone" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('guest_phone') }}">
                            @error('guest_phone')
                                <p class="text-error-dark text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="plus_ones_count" id="plus_ones_count" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('plus_ones_count', 0) }}" min="0">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="meal_preference" id="meal_preference" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('meal_preference') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="special_requests" id="special_requests" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" rows="3">{{ old('special_requests') }}</textarea>
