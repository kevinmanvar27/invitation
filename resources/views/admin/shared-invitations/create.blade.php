                ...
                <div class="p-6 text-primary-dark">
                    ...
                    <form method="POST" action="{{ route('admin.shared-invitations.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="recipient_email" id="recipient_email" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('recipient_email') }}" placeholder="recipient@example.com">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="recipient_phone" id="recipient_phone" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('recipient_phone') }}" placeholder="+1234567890">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="share_token" id="share_token" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('share_token') }}" placeholder="Unique share token">
                            @error('share_token')
                                <p class="text-error-dark text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="view_count" id="view_count" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('view_count', 0) }}" min="0">
                            @error('view_count')
                                <p class="text-error-dark text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
