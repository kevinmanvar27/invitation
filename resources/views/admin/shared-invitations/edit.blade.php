                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.shared-invitations.update', $sharedInvitation->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="recipient_email" id="recipient_email" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('recipient_email', $sharedInvitation->recipient_email) }}" placeholder="recipient@example.com">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="recipient_phone" id="recipient_phone" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('recipient_phone', $sharedInvitation->recipient_phone) }}" placeholder="+1234567890">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="share_token" id="share_token" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('share_token', $sharedInvitation->share_token) }}" placeholder="Unique share token">
                            @error('share_token')
                                <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="view_count" id="view_count" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('view_count', $sharedInvitation->view_count) }}" min="0">
                            @error('view_count')
                                <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <!-- Sent At -->
                        <div class="mb-4">
                            <label for="sent_at" class="block text-gray-700 text-sm font-bold mb-2">Sent At</label>
                            <input type="datetime-local" name="sent_at" id="sent_at" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('sent_at', $sharedInvitation->sent_at ? $sharedInvitation->sent_at->format('Y-m-d\TH:i') : '') }}">
                            @error('sent_at')
                                <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <!-- Viewed At -->
                        <div class="mb-4">
                            <label for="viewed_at" class="block text-gray-700 text-sm font-bold mb-2">Viewed At</label>
                            <input type="datetime-local" name="viewed_at" id="viewed_at" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('viewed_at', $sharedInvitation->viewed_at ? $sharedInvitation->viewed_at->format('Y-m-d\TH:i') : '') }}">
                            @error('viewed_at')
                                <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
