                ...
                <div class="p-6 text-primary-dark">
                    ...
                    <form method="POST" action="{{ route('admin.tags.update', $templateTag->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="tag_name" id="tag_name" class="shadow appearance-none border rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('tag_name', $templateTag->tag_name) }}" required>
                            @error('tag_name')
                                <p class="text-error-dark text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
