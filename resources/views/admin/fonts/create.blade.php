        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-primary-dark">
                    <h3 class="text-lg font-medium mb-4">Add New Font</h3>
                    ...
                    <form method="POST" action="{{ route('admin.fonts.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="font_name" id="font_name" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('font_name') }}" required>
                            @error('font_name')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="font_family" id="font_family" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('font_family') }}" required>
                            @error('font_family')
                                <p class="text-error-dark text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="font_file_path" id="font_file_path" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('font_file_path') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="font_weight" id="font_weight" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('font_weight') }}">
                            @error('font_weight')
                                <p class="text-error-dark text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="language_support" id="language_support" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('language_support') }}">
