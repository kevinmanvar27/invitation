                ...
                <div class="p-6 text-primary-dark">
                    ...
                    <form method="POST" action="{{ route('admin.rsvp-settings.update', $rsvpSetting->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="deadline" id="deadline" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('deadline', $rsvpSetting->deadline ? $rsvpSetting->deadline->format('Y-m-d') : '') }}">
                            @error('deadline')
                                <p class="text-error-dark text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="max_guests_per_invite" id="max_guests_per_invite" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('max_guests_per_invite', $rsvpSetting->max_guests_per_invite) }}" min="1">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="custom_questions" id="custom_questions" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" rows="4">{{ old('custom_questions', json_encode($rsvpSetting->custom_questions)) }}</textarea>
