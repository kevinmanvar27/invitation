                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.rsvp-settings.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="deadline" id="deadline" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('deadline') }}">
                            @error('deadline')
                                <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="max_guests_per_invite" id="max_guests_per_invite" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('max_guests_per_invite') }}" min="1">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="custom_questions" id="custom_questions" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" rows="4">{{ old('custom_questions') }}</textarea>
