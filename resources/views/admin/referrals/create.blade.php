                ...
                <div class="p-6 text-primary-dark">
                    ...
                    <form method="POST" action="{{ route('admin.referrals.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.01" name="reward_earned" id="reward_earned" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('reward_earned', 0) }}">
                            @error('reward_earned')
                                <p class="text-error-dark text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
