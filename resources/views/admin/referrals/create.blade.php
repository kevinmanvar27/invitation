                ...
                <div class="card-header">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <small class="text-muted">Enter referral information</small>
                        </div>
                    </div>
                </div>
                <form method="POST" action="{{ route('admin.referrals.store') }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" min="0" class="form-control @error('reward_earned') is-invalid @enderror" id="reward_earned" name="reward_earned" value="{{ old('reward_earned', 0) }}" placeholder="0.00">
                                    @error('reward_earned')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="card-footer d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-check me-1"></i> Create Referral
                        </button>
                    </div>
                </form>
            </div>
