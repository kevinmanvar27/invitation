        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-medium mb-4">Edit User Profile</h3>
                    ...
                    <form method="POST" action="{{ route('admin.user-profiles.update', $userProfile->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="partner_name" id="partner_name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('partner_name', $userProfile->partner_name) }}">
                            @error('partner_name')
                                <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="wedding_date" id="wedding_date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('wedding_date', $userProfile->wedding_date ? $userProfile->wedding_date->format('Y-m-d') : '') }}">
                            @error('wedding_date')
                                <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @if($userProfile->profile_picture)
                                <div class="mt-2">
                                    <img src="{{ asset($userProfile->profile_picture) }}" alt="Current Profile Picture" class="w-32 h-32 object-cover rounded">
                                </div>
                            @endif
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="preferences" id="preferences" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" rows="4">{{ old('preferences', json_encode($userProfile->preferences)) }}</textarea>
