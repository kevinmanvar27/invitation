<x-admin-layout>
    <x-slot name="header">
        <div class="page-header">
            ...
            <p class="text-gray-500 text-sm mt-1">View and manage all discount coupons</p>
        </div>
    </x-slot>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        ...
                        <div class="stat-card">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-gray-500">Total Discount Given</p>
                                    <p class="text-2xl font-semibold text-gray-900">₹0</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="stat-card">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-gray-500">Most Used Coupon</p>
