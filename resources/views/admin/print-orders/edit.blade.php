                ...
                <div class="p-6 text-primary-dark">
                    ...
                    <form method="POST" action="{{ route('admin.print-orders.update', $printOrder->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="quantity" id="quantity" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('quantity', $printOrder->quantity) }}" min="1" required>
                            @error('quantity')
                                <p class="text-error-dark text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.01" name="unit_price" id="unit_price" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('unit_price', $printOrder->unit_price) }}" required>
                            @error('unit_price')
                                <p class="text-error-dark text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <!-- Total Price -->
                        <div class="mb-4">
                            <label for="total_price" class="block text-primary-dark text-sm font-bold mb-2">Total Price</label>
                            <input type="number" step="0.01" name="total_price" id="total_price" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('total_price', $printOrder->total_price) }}" required>
                            @error('total_price')
                                <p class="text-error-dark text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.01" name="discount" id="discount" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('discount', $printOrder->discount) }}">
                            @error('discount')
                                <p class="text-error-dark text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="tracking_number" id="tracking_number" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('tracking_number', $printOrder->tracking_number) }}">
                        ...
                        <!-- Ordered At -->
                        <div class="mb-4">
                            <label for="ordered_at" class="block text-primary-dark text-sm font-bold mb-2">Ordered At</label>
                            <input type="datetime-local" name="ordered_at" id="ordered_at" class="shadow appearance-none border border-accent rounded w-full py-2 px-3 text-primary-dark leading-tight focus:outline-none focus:shadow-outline" value="{{ old('ordered_at', $printOrder->ordered_at ? $printOrder->ordered_at->format('Y-m-d\TH:i') : '') }}">
                            @error('ordered_at')
                                <p class="text-error-dark text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
