                ...
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h5 class="mb-0">Order #{{ $printOrder->id }}</h5>
                                <small class="text-muted">{{ $printOrder->user->name ?? 'Unknown User' }}</small>
                            </div>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            ...
                            @endif
                            <a href="{{ route('admin.print-orders.show', $printOrder) }}" class="btn btn-sm btn-outline-primary">
                ...
                <form method="POST" action="{{ route('admin.print-orders.update', $printOrder->id) }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="bg-light rounded p-3 mb-4">
                            <div class="row text-center">
                                <div class="col-3">
                                    ...
                                    <span class="fw-medium text-success">${{ number_format($printOrder->total_price, 2) }}</span>
                                </div>
                                <div class="col-3">
                                    <small class="text-muted d-block">Quantity</small>
                                    <span class="fw-medium">{{ $printOrder->quantity }}</span>
                                </div>
                                <div class="col-3">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="quantity" id="quantity" class="form-control @error('quantity') is-invalid @enderror" value="{{ old('quantity', $printOrder->quantity) }}" min="1" required>
                                @error('quantity')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" name="unit_price" id="unit_price" class="form-control @error('unit_price') is-invalid @enderror" value="{{ old('unit_price', $printOrder->unit_price) }}" required>
                                    @error('unit_price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number" step="0.01" name="total_price" id="total_price" class="form-control @error('total_price') is-invalid @enderror" value="{{ old('total_price', $printOrder->total_price) }}" required>
                                    @error('total_price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number" step="0.01" name="discount" id="discount" class="form-control @error('discount') is-invalid @enderror" value="{{ old('discount', $printOrder->discount) }}">
                                    @error('discount')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <!-- Ordered At -->
                            <div class="col-md-3">
                                <label for="ordered_at" class="form-label">Ordered At</label>
                                <input type="datetime-local" name="ordered_at" id="ordered_at" class="form-control @error('ordered_at') is-invalid @enderror" value="{{ old('ordered_at', $printOrder->ordered_at ? $printOrder->ordered_at->format('Y-m-d\TH:i') : '') }}">
                                @error('ordered_at')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <!-- Shipping Section -->
                        <h6 class="text-muted mb-3"><i class="fas fa-shipping-fast me-2"></i>Shipping</h6>
                        <div class="row g-3">
                            <!-- Tracking Number -->
                            <div class="col-md-6">
                                <label for="tracking_number" class="form-label">Tracking Number</label>
                                <input type="text" name="tracking_number" id="tracking_number" class="form-control @error('tracking_number') is-invalid @enderror" value="{{ old('tracking_number', $printOrder->tracking_number) }}" placeholder="Enter tracking number">
                    ...
                    <div class="card-footer d-flex justify-content-between">
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('admin.print-orders.show', $printOrder) }}" class="btn btn-outline-primary">
                                <i class="fas fa-eye me-1"></i> View
                            </a>
