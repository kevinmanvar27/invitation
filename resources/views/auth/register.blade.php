...
<div class="min-h-screen bg-gradient-to-br from-secondary-light via-accent-light to-primary-light flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
    ...
    <div class="absolute top-20 left-10 w-24 h-24 rounded-full bg-secondary/20 blur-2xl animate-pulse-slow"></div>
    <div class="absolute bottom-20 right-10 w-32 h-32 rounded-full bg-accent/20 blur-2xl animate-pulse-slow delay-1000"></div>
            ...
            <div class="lg:w-1/2 text-center lg:text-left animate-fade-in-up">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-5 shadow-lg border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                        ...
                        <h3 class="text-lg font-semibold text-primary-dark">Beautiful Templates</h3>
                        <p class="mt-2 text-secondary-dark text-sm">Hundreds of professionally designed templates</p>
                    </div>
                    ...
                    <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-5 shadow-lg border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                        ...
                        <h3 class="text-lg font-semibold text-primary-dark">Easy Customization</h3>
                        <p class="mt-2 text-secondary-dark text-sm">Personalize every detail with our intuitive editor</p>
                    </div>
                    ...
                    <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-5 shadow-lg border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                        ...
                        <h3 class="text-lg font-semibold text-primary-dark">RSVP Management</h3>
                        <p class="mt-2 text-secondary-dark text-sm">Track guest responses and manage your guest list</p>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-secondary-light to-accent-light rounded-2xl p-6 shadow-lg border border-secondary-light max-w-lg mx-auto lg:mx-0">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <h4 class="text-lg font-semibold text-primary-dark">Sarah & John</h4>
                            <p class="text-secondary-dark italic">"Creating our wedding invitations was so easy and fun! The templates are beautiful and customization was a breeze."</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:w-1/2 w-full max-w-md animate-slide-up">
                <div class="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl p-8 border border-secondary-light/50 transform transition-all duration-500 hover:shadow-2xl animate-pop-in">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <h2 class="text-3xl font-bold text-primary-dark">Create your account</h2>
                        <p class="mt-2 text-secondary-dark">
                            Already have an account? 
                            <a href="{{ route('login') }}" class="font-medium text-accent hover:text-accent-dark transition-colors duration-300">
                                Sign in
                            </a>
                        </p>
                    </div>
                    ...
                    <form class="space-y-6" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="relative group animate-fade-in-up delay-150">
                                <label for="name" class="block text-sm font-medium text-secondary-dark mb-1 transition-all duration-300">
                                    Full Name
                                </label>
                                <div class="mt-1 relative rounded-xl shadow-sm transition-all duration-300 group-hover:shadow-md">
                                    ...
                                    <input 
                                        ...
                                        type="text" 
                                        required 
                                        class="py-4 px-4 pl-12 block w-full rounded-xl border border-secondary shadow-sm focus:ring-4 focus:ring-accent/20 focus:border-accent transition-all duration-300 hover:border-accent @error('name') border-error @enderror" 
                                        value="{{ old('name') }}"
                            ...
                            <div class="relative group animate-fade-in-up delay-500">
                                ...
                                <div class="mt-1 relative rounded-xl shadow-sm transition-all duration-300 group-hover:shadow-md">
                                    ...
                                    <input 
                                        ...
                                        required 
                                        class="py-4 px-4 pl-12 block w-full rounded-xl border border-secondary shadow-sm focus:ring-4 focus:ring-accent/20 focus:border-accent transition-all duration-300 hover:border-accent @error('password') border-error @enderror password-input" 
                                        placeholder="••••••••">
                                </div>
                                ...
                                <div class="mt-2">
                                    <div class="flex items-center">
                                        <div class="w-full bg-secondary rounded-full h-2.5">
                                            <div id="password-strength" class="h-2.5 rounded-full bg-secondary-dark transition-all duration-300 ease-in-out" style="width: 0%"></div>
                                        </div>
                                        <span id="password-strength-text" class="ml-3 text-sm font-medium text-secondary-dark">Password strength</span>
                                    </div>
                                    <div class="mt-2 grid grid-cols-4 gap-1">
                                        <div class="h-1 rounded-full bg-secondary"></div>
                                        <div class="h-1 rounded-full bg-secondary"></div>
                                        <div class="h-1 rounded-full bg-secondary"></div>
                                        <div class="h-1 rounded-full bg-secondary"></div>
                                    </div>
                            ...
                            <div class="relative group animate-fade-in-up delay-750">
                                <label for="password_confirmation" class="block text-sm font-medium text-secondary-dark mb-1 transition-all duration-300">
                                    Confirm Password
                                </label>
                                <div class="mt-1 relative rounded-xl shadow-sm transition-all duration-300 group-hover:shadow-md">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    ...
                                    <input 
                                        ...
                                        autocomplete="new-password" 
                                        required 
                                        class="py-4 px-4 pl-12 block w-full rounded-xl border border-secondary shadow-sm focus:ring-4 focus:ring-accent/20 focus:border-accent transition-all duration-300 hover:border-accent @error('password_confirmation') border-error @enderror" 
                                        placeholder="••••••••">
                                </div>
                            </div>
                        </div>
