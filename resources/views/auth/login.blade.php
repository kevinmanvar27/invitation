            ...
            <div class="lg:w-1/2 text-center lg:text-left animate-fade-in-up">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-5 shadow-lg border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900">Manage Invitations</h3>
                        <p class="mt-2 text-gray-600 text-sm">Easily update and customize your wedding invitations</p>
                    </div>
                    ...
                    <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-5 shadow-lg border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900">Track RSVPs</h3>
                        <p class="mt-2 text-gray-600 text-sm">Monitor guest responses and manage your guest list</p>
                    </div>
                    ...
                    <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-5 shadow-lg border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900">Wedding Planning</h3>
                        <p class="mt-2 text-gray-600 text-sm">Access tools to plan and organize your special day</p>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 shadow-lg border border-gray-100 max-w-lg mx-auto lg:mx-0">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <h4 class="text-lg font-semibold text-gray-900">Michael & Jennifer</h4>
                            <p class="text-gray-700 italic">"Managing our wedding invitations and RSVPs through this platform made our planning so much easier. Highly recommended!"</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl p-8 border border-gray-100/50 transform transition-all duration-500 hover:shadow-2xl animate-pop-in">
                    ...
                    <form class="space-y-6" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="relative group animate-fade-in-up delay-300">
                                ...
                                <div class="mt-1 relative rounded-xl shadow-sm transition-all duration-300 group-hover:shadow-md">
                                    ...
                                    <input 
                                        ...
                                        required 
                                        class="py-4 px-4 pl-12 block w-full rounded-xl border border-gray-300 shadow-sm focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 hover:border-blue-400 @error('password') border-red-300 @enderror" 
                                        placeholder="••••••••">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between animate-fade-in-up delay-500">
                            ...
                            <div class="text-sm">
                                <a href="#" class="font-medium text-blue-600 hover:text-blue-500 transition-colors duration-300 hover:underline">
                    ...
                    <div class="mt-6 text-center animate-fade-in-up delay-1000">
                        <p class="text-gray-600">
                            ...
                            <a href="{{ route('register') }}" class="font-semibold text-blue-600 hover:text-blue-500 transition-colors duration-300 underline decoration-dotted">
                                Create one now
                            </a>
                        </p>
                    </div>
